...
\section{Work Experience}
    ...
    \begin{tabular}{r|p{14cm}}
        % ADS
        \emph{March 2021} & Machine Learning and Natural Language Processing Specialist for the SAO/NASA Astrophysics Data System at the Center for Astrophysics | Harvard \& Smithsonian.\\
        & \small{Designed, trained and evaluated machine learning / deep learning models that expand the functionality of the ADS search engine with new capabilities and services.}\\
