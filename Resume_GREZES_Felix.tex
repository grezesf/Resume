...
\par{
    ...
    \hspace*{\fill} {\large 19 Hamilton Terrace, Apt. 1K New York, NY}
    \bigskip
    \par}
...
\section{Work Experience}
    ...
    \begin{tabular}{r|p{14cm}}
        % Apple Internship
        \emph{Summer 2018} & Machine Learning Engineer for {\bfseries Apple} on the Siri Speech team on Cheltenham, UK\\
